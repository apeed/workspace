$(function(){
	...
	$(".sheade_shezhi_zz").click(function(){
...
/*新建订单/订单编辑里边的添加商品弹出框*/
	...
	var alert_data_box=$(".alert_data-box");
	var alert_page=$(".alert_page");
	alert_page.click(function(){
		alert_data_box.css("display","block");
	})
	delete_btn.click(function(){
		alert_data_box.css("display","none");
	})
	// var content_box=$(".content_box");
	// var content_box_height= content_box.height()+"px";
	// alert_data_box.css("height",content_box_height);
	...
	var template_shade=$(".template_shade");
	var template_btn=$(".template_btn");
	add_template.click(function(){
		template_shade.css("display","block");
	})
	template_btn.click(function(){
		template_shade.css("display","none");
	})


	// 自定义单据模板弹出实现选中效果
	var template_content_list1=$(".template_content_list1");
	var radio_checked=$(".radio_checked")
	template_content_list1.find(".radio_checked").click(function(){
		 var index = $(this).index();
		radio_checked.eq(index-1).children("input").prop('checked', true);
	})
	var template_content_list2=$(".template_content_list2");
	var img_checked=$(".img_checked")
	template_content_list2.find(".img_checked").click(function(){
		 var index = $(this).index();
		img_checked.eq(index-1).children("input").prop('checked', true);
	})


/*批量打印面单/批量打印发货单弹出框*/
	var pl_express_btn=$(".pl_express_btn");
	var pl_shipments_btn=$(".pl_shipments_btn");
	var del_express_btn=$(".del_express_btn");
	var express_box=$(".express_box");
	var xz_mb=$(".xz_mb")
	pl_express_btn.click(function(){
		express_box.css("display","block");
	})
	pl_shipments_btn.click(function(){
		express_box.css("display","block");
	})
	xz_mb.click(function(){
		express_box.css("display","block");
	})
	del_express_btn.click(function(){
