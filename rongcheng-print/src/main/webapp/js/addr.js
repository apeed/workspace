...
function change(v) {
	...
	with (ss) {
		length = 0;
		options[0] = new Option(opt0[v], opt00[v]);
		if (v && document.getElementById(s[v - 1]).selectedIndex > 0 || !v) {
			if (dsy.Exists(str)) {
				ar = dsy.Items[str];
				var patrn=/^[0-9]{1,20}$/; 
				if(str=="0" || /^0_\d{1}$/.test(str)){
...
dsy.add("0_0_0", [ "378","东城区","379", "西城区","382", "朝阳区","383",  "丰台区", "384", "石景山区", "385","海淀区","386","门头沟区", "387","房山区", "388","通州区",  "389","顺义区",  "390","昌平区",  "391","大兴区",  "392","怀柔区",  "393","平谷区",  "394","密云县",  "395","延庆县"]);
dsy.add("0_0", ["北京市" ]);
dsy.add("0_1_0", [ "396","和平区",  "397","河东区",  "398","河西区",  "399","南开区",  "400","河北区", "401","红桥区", "404","滨海新区", "405","东丽区", "406","西青区", "407","津南区", "408","北辰区", "409","武清区", "410","宝坻区", "411","宁河县", "412","静海县", "413","蓟县" ]);
dsy.add("0_1", [ "天津市" ]);
...
dsy.add("0_4_0", [	"415","长安区", "416","桥东区", "417","桥西区", "418","新华区",  "419","井陉矿区","420","裕华区", "421","井陉县",
					"422","正定县", "423","栾城县", "424","行唐县", "425","灵寿县", "426","高邑县", "427","深泽县", "428","赞皇县", "429","无极县",
					"430","平山县", "431","元氏县", "432","赵县", "433","辛集市", "434","藁城市","435", "晋州市", "436","新乐市", "437","鹿泉市" ]);

dsy.add("0_4_1", [	"528","桥东区", "529","桥西区", "530","宣化区", "531","下花园区", "532","宣化县", "533","张北县", "534","康保县", "535","沽源县",
					"536","尚义县", "537","蔚县",   "538","阳原县", "539","怀安县",   "540","万全县", "541","怀来县", "542","涿鹿县", "543","赤城县",
					"544","崇礼县"  ]);

dsy.add("0_4_2", [	"546","双桥区", "547","双滦区", "548","鹰手营子矿区", "549","承德县", "550","兴隆县", "551","平泉县", "552","滦平县",
					"553","隆化县", "554","丰宁满族自治县", "555","宽城满族自治县", "556","围场满族蒙古族自治县"]);

dsy.add("0_4_3", [	"454","海港区", "455","山海关区", "456","北戴河区", "457","青龙满族自治县", "458","昌黎县",  "459","抚宁县", "460","卢龙县" ]);

dsy.add("0_4_4", [	"439","路南区", "440","路北区", "441","古冶区", "442","开平区", "443","丰南区", "444","丰润区", "445","滦县", 
					"446","滦南县", "447","乐亭县", "448","迁西县", "449","玉田县", "450","唐海县", "451","遵化市", "452","迁安市"]);

dsy.add("0_4_5", [	"575","安次区", "576","广阳区" ,"577","固安县","578","永清县","579","香河县","580","大城县", "581","文安县", "582","大厂回族自治县", "583","霸州市", "584","三河市" ]);

dsy.add("0_4_6", [	"502","新市区", "503","北市区", "504","南市区", "505","满城县", "506","清苑县", "507","涞水县", "508","阜平县", "509","徐水县", 
					"510","定兴县", "511","唐县",   "512","高阳县", "513","容城县", "514","涞源县", "515","望都县", "516","安新县", "517","易县", 
					"518","曲阳县", "519","蠡县",   "520","顺平县", "521","博野县", "522","雄县",   "523","涿州市", "524","定州市", "525","安国市",
					"526","高碑店市"]);

dsy.add("0_4_7", [	"586","桃城区", "587","枣强县", "588","武邑县", "589","武强县", "590","饶阳县", "591","安平县", "592","故城县", "593","景县", "594","阜城县", "595","冀州市", "596","深州市"]);

dsy.add("0_4_8", [	"558","新华区", "559","运河区", "560","沧县","561","青县","562","东光县","563","海兴县", "564","盐山县", "565","肃宁县", "566","南皮县",
					"567","吴桥县", "568","献县",   "569","孟村回族自治县",   "570","泊头市", "571","任丘市", "572","黄骅市", "573","河间市" ]);

dsy.add("0_4_9", [ 	"482","桥东区", "483","桥西区", "484","邢台县", "485","临城县", "486","内丘县", "487","柏乡县", "488","隆尧县", "489","任县",
					"490","南和县", "491","宁晋县", "492","巨鹿县", "493","新河县", "494","广宗县", "495","平乡县", "496","威县",   "497","清河县",
					"498","临西县", "499","南宫市", "500","沙河市"  ]);

dsy.add("0_4_10", [ "462","邯山区", "463","丛台区", "464","复兴区", "465","峰峰矿区", "466","邯郸市", "467","临漳县", "468","成安县",
					"469","大名县", "470","涉县",   "471","磁县",   "472","肥乡县",   "473","永年县", "474","邱县",   "475","鸡泽县",
					"476","广平县", "477","馆陶县", "478","魏县",   "479","曲周县",   "480","武安市"]);
...
dsy.add("0_8_2", [ "999","宁江区", "1003","扶余县", "1001","长岭县",  "1002","乾安县",
                   "1000","前郭尔罗斯蒙古族自治县" ]);

dsy.add("0_8_3", ["964","船营区","1000","龙潭区","1000","昌邑区","965","丰满区","1000","磐石市","1000","蛟河市","1000","桦甸市","1000","舒兰市",
		"永吉县","1000","口前镇" ]);
dsy.add("0_8_4",
...
dsy.add("0_33_0", [ " " ]);
dsy.add("0_33", [ "台北市", "高雄市", "台中市", "花莲市", "基隆市", "嘉义市", "金门市", "连江市",
		"苗栗市", "南投市", "澎湖市", "屏东市", "台东市", "台南市", "桃园市", "新竹市", "宜兰市", "云林市",
		"彰化市" ]);
dsy.add("0", [ "北京市", "天津市", "上海市", "重庆市", "河北省", "山西省", "内蒙古自治区", "辽宁省",
		"吉林省", "黑龙江省", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省",
		"湖南省", "广东省", "广西壮族自治区", "海南省", "四川省", "贵州省", "云南省", "西藏自治区", "陕西省",
