	...
	function sub(e) {
		if (e == "sub") {
			...
			$.ajax({
				...
				var ownerId = map.ownerId;	
				/* 	console.log(map); */
					document.getElementById("loading").style.display="none";
					 if (userName == null || userName == "验证码错误") {
						$("#err").html(map); 
					} else {
						addCookie("userName", userName); 
						addCookie("ownerId", ownerId);
						window.location.assign("index.do");
					}
				},
		...
		<div class="line bouncein">
			<div class="xs6 xm4 xs3-move xm4-move">
				...
				<div class="panel loginbox">
						...
						<form id="loginForm">
							<div>
								<div class="field field-icon-right">
									<input class="input input-big" name="accountNum" placeholder="账号" />
					...
					<div>
						<input type="button" id="login" class="button button-block bg-main text-big input-big" value="登录" style="margin-bottom: 10px;" onclick="sub('sub')"></div>
						<a href="sign.do">如果没有账号请点击这里<span style="color: red;">注册</span></a>
				</div>
			</div>
		</div>
	</div>
	<img src="images/loading.gif"  id="loading" style="display: none; position: fixed;top: 40%;left: 50%; "/>
</body>
</html>