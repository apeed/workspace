...
<body>
  ...
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder">待打印订单</strong></div>
    <div class="table table-hover text-center">
      ...
      <ul class="table-ul">
        <li><input type="checkbox" id="checkall"/>
          全选 </li>      
        <li style="width: 90%">
          <a class="button border-main" href="javascript:;"><span class="icon-print"></span> 批量打印电子面单</a> 
          <a class="button border-main" href="javascript:;"><span class="icon-print"></span> 批量打印普通面单</a> 
          <a class="button border-main" href="javascript:;"><span class="icon-print"></span> 批量打印发货单</a> 
