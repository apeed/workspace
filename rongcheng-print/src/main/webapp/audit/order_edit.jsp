...
<body>
  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search">
        <li>
          <a class="button border-main btn_shezhi" href="javascript:;"><span class="icon-edit"></span>设置</a>
        </li>
      </ul>
    </div>
    <div class="table table-hover text-center">
      ...
      <ul class="table-ul">
        ...
        <li>
          <div class="button-group">
            <a class="button border-main" href="order_edit_ament.jsp"><span class="icon-edit"></span> 修改</a>
      ...
      <ul class="table-ul">
        ...
        <li style="width: 90%">
          ...
          <a class="button border-main" href="javascript:;"><span class="icon-edit"></span> 批量审批</a>
          <a class="button border-main" href="javascript:;"><span class="icon-edit"></span> 订单关闭</a>
        </li>  
      </ul> 
      <ul class="table-ul">
        <li style="width: 100%">
