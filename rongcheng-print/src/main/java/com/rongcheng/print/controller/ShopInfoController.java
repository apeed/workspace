...
public class ShopInfoController {
	...
	@ResponseBody
	public JsonResult addShopInfo(String name,String sellerAccount,String contactName,String contactTel,String userAddress){
	int n=service.addShopInfo(name, sellerAccount, contactName, contactTel, userAddress);
