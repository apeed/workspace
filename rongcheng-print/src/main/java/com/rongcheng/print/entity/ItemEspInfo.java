...
public class ItemEspInfo implements Serializable{
	private static final long serialVersionUID = 1827751894569293803L;
...
public ItemEspInfo(BigInteger id, String name, BigInteger platformId, BigInteger platformItemSku, String spec,
		...
		String styleCode, BigInteger warehouseId, String reserved1, String reserved2, String note, Boolean authorized,
...
public String toString() {
	return "ItemEspInfo [id=" + id + ", name=" + name + ", platformId=" + platformId + ", platformItemSku="
			...
			+ reserved2 + ", note=" + note + ", authorized=" + authorized + ", itemId=" + itemId + ", ownerId="
