...
public class OrderItemLink implements Serializable{
    ...
    private BigInteger erp_order_id;
    ...
    //有参数的构造器
    public OrderItemLink(BigInteger id, BigInteger erp_order_id,
    ...
    public BigInteger getErp_order_id() {
        return erp_order_id;
    }

    public void setErp_order_id(BigInteger erp_order_id) {
        this.erp_order_id = erp_order_id;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((erp_order_id == null) ? 0 : erp_order_id.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (authorized == null) {
            ...
            return false;
        if (erp_order_id == null) {
            if (other.erp_order_id != null)
                return false;
        } else if (!erp_order_id.equals(other.erp_order_id))
            return false;
        if (gmtCreate == null) {
    ...
    public String toString() {
        return "OrderItemLink [id=" + id + ", erp_order_id="
                + erp_order_id + ", orderItemId=" + orderItemId + ", quantity=" + quantity + ", reserved1=" + reserved1
