...
<body>
  ...
  <form class="form-x" id="addColumn_form">   
    ...
    <div class="form-group">
      ...
      <div class="field">
        <input type="text" readonly="readonly" id="addColumn_link" name="banner" class="input tips" style="width:25%; float:left; background: #FFF;"  value="" />
        <button type="button" class="btn btn-warning btn-s file-button" id="btn1" onclick="addColumn_myfile.click();" style="float: left;">
          <span class="glyphicon glyphicon-ban-circle"></span>十上传
        </button>
        <input type="file" id="addColumn_myfile" name="upfile"  class="file-btn">
        <div class="tips"></div>
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="field">
        <button class="button bg-main icon-check-square-o" type="button" id="addColumn_button"> 提交</button>
      </div>
    </div>
  </form>
  </div>
