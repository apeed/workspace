...
<script src="/backstage/js/addContent.js"></script>  
...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form class="form-x" id="addContent_form">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" readonly="readonly" id="addContent_link" name="img" class="input tips" style="width:25%;background: #FFF; float:left;"  value=""/>
          <button type="button" class="btn btn-warning btn-s file-button" id="btn1" onclick="addContent_myfile.click();" style="float: left;">
            <span class="glyphicon glyphicon-ban-circle"></span>十上传
          </button>
          <input type="file" id="addContent_myfile" name="upfile" class="file-btn">
        </div>
      </div>     
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <select name="cid" class="input w50" id="addContent_menu">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button class="button bg-main icon-check-square-o" type="button" id="addContent_button"> 提交</button>
        </div>
      </div>
    </form>
  </div>
