...
//
//at sun.awt.windows.WPrinterJob.setNativePrintService(Native Method)    at sun.awt.windows.WPrinterJob.getPrintService(WPrinterJob.java:573)    at sun.print.RasterPrinterJob.print(RasterPrinterJob.java:1272)    at sun.print.RasterPrinterJob.print(RasterPrinterJob.java:1247)    at com.printDome.main(printDome.java:137)
//
// 
//
////其次，确保计算机与打印机之间连接通畅。
...
//
//
//继承（implements ）Printable​ 实现 print（）；方法。
