...
public class UserRemarkServiceImpl implements UserRemarkService {
	...
	//增加方法
	public int addUserRemark(Long ownerId, Date gmtCreate, Long operatorId,String userAccount,
			Long userId, String userWord, Date userWordTime,
			Integer remarkType, Boolean show, String note, Byte contentType,Long contentId) {
