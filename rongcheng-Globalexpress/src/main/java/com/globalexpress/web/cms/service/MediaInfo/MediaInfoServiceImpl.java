package com.globalexpress.web.cms.service.MediaInfo;
...
public class MediaInfoServiceImpl implements MediaInfoService {
	...
	public Object[] pageByOwnerIdAndKeyword(Long ownerId, int page, int rows, String blockChannelId, String keyword) {
		int maxPage = (int) Math.ceil(new Double(mediaInfoDAO.countByBlockIdAndKeyword(ownerId,blockChannelId,keyword))/rows);
		if(maxPage == 0){
