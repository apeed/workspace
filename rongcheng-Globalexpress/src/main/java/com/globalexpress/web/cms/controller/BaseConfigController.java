...
//	private Long ownerId;
	...
	public String contactUs(HttpServletRequest request, HttpSession session) {
		return "admin/config/contact-us";
	}
	...
	public Object updateConfig(HttpServletRequest request, HttpSession session) {
		...
		String imgPath = "/media/images/public/";
		try {
			Map<String, String> map = JimlUtil.saveMultipartFileUseInputTagNameValue(request, imgPath, ownerId+"");
	...
	public Object LoadUsersInfo(HttpServletRequest request, HttpSession session) {
		...
		Object[] array = userInfoServiceJXB.listByOwnerIdAndPage(ownerId, new Byte[]{2,3}, page, rows);
