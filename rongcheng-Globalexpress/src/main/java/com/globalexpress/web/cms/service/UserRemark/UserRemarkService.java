...
public interface UserRemarkService {
	 ...
	 int addUserRemark(Long ownerId,Date gmtCreate,Long operatorId,String userAccount,Long userId,
			String userWord,Date userWordTime,Integer remarkType,Boolean show,String note,Byte contentType,Long contentId);
	//批量修改
	 void modifyUserRemarks(Long[] id,Long ownerId,Boolean show);
	 void updateUserRemarks(Long[] id,Long ownerId,Boolean reply,Long operatorId,Date gmtModified);//不予回复
