		...
		<div class="body-content">
			<div class="form-x">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="password" class="input w50" id="password" name="password" value="" size="50" placeholder="请输入原始密码" autocomplete="off" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
					<div class="label">
						<label>新密码：</label></div>
					<div class="field">
						<input type="password" class="input w50 newPassword" id="newPassword1" name="newPassword" value="" size="50" placeholder="请输入新密码" autocomplete="off" />
						<div class="tips"><span class="icon-check" style="color:#2c7; display: none"></span></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="field">
						<input type="password" class="input w50 newPassword" id="newPassword2" value="" size="50" placeholder="请再次输入新密码" autocomplete="off" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="field">
						<button class="button bg-main icon-check-square-o" id="subButton" type="button">提交</button></div>
