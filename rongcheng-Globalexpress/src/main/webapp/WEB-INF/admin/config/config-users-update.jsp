      ...
      <div class="form-group">
        ...
        <div class="field">
          <div class="button-group radio">
              <input name="accountStatus" value="1" type="radio" <c:if test="${user.accountStatus==1 }">checked="checked"</c:if>>是
              <span><span class="icon-check" style="color:#2c7; display: none"></span></span>
              <input name="accountStatus" value="0"  type="radio" <c:if test="${user.accountStatus==0 }">checked="checked"</c:if>>否
              <span><span class="icon-check" style="color:#2c7; display: none"></span></span>
          </div>       
        </div>
      </div>
