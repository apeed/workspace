      ...
      <div class="padding border-bottom">
        <ul class="search" style="padding-left:10px;">
          ...
          <li>
            ...
            <button type="button" class="button border-black  recommend_btn"> 批量归类</button>
          </li>
          <li>
          ...
          <li>
            <input type="text" placeholder="可输入内容页标题/子标题/作者/详情/简介/标签/备注信息" name="keywords" class="input" style="width:400px; line-height:17px;display:inline-block" />
  ...
  <div class="recommend_box">
    <div class="recommend_content">
      ...
      <div class="recommend_tj">
        <button class="button border-main"style="margin-right: 50px;"><span class="icon-print"></span> 确定</button> 
      </div>
    </div>
  </div>
<!-- 图片放大弹出 -->
