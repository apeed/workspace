...
<head>
    ...
    <script src="/admin/jxb/js/content/content.js"></script>
</head>
      ...
      <div class="padding border-bottom">
        <ul class="search" style="padding-left:10px;">
          ...
          <li>
            ...
            <a href="javascript:void(0)" class="button border-main icon-search" onclick="loadData(1)" > 搜索</a></li>
        </ul>
      </div>
      		<form id="subForm">
...
<!-- 推荐到 -->
  <div class="recommend_box">
    <div class="recommend_content">
      ...
      <h3 id="saveOrDeleteGuiLei">归类到：</h3>
      <ul class="recommend">
        <li class="change_column_fu">
          <ol>
        ...
        <li class="change_column_fu">
          ...
          <div>
            <ol>
              <li><input type="checkbox" name="blockChannelId"></li>
              <li style="padding-left: 30px;">├─公司简介</li>
            </ol>
            <div>
              <ol>
