...
function loadBook(page) {
	...
	var sa="";
	sa+='<tr>';
	sa+='<th width="80">ID</th>';
	sa+='<th>姓名</th>';
	sa+='<th>电话</th>';
	sa+='<th width="400">内容</th>';
	sa+='<th>页面名称</th>';
	...
	for(var i=0;i<list.length;i++){
		...
		var contentType = UserRemark.contentType;
		...
		if(contentType==2){
			str+='<a href="/show.do?id='+contentId+'&contentType=2">多媒体文件内容</a></td>';	
		}
		if(contentType==3){
			str+='<td><a href="/show.do?id='+contentId+'&contentType=3">商品内容</a></td>';
		}
