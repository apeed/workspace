 ...
 */
function queueShowMessage(message, messageTop, messageLeft, fontSize, showTime){
		...
		myInterval = setInterval(
			function(){
				if(showEnd){
					...
					showMessage(messageArray.pop(), messageTop, messageLeft, fontSize, showTime);
					showEnd = false;
				}
			}
			,1
 ...
 * @param showTime 		提示信息稳定显示时长（默认值1500，单位毫秒）
 */
function showMessage(message, messageTop, messageLeft, fontSize, showTime) {
	var time2 = 500;//动画时长
