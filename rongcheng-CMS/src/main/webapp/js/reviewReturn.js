...
function loadReviewReturn(){
	...
	$.ajax({
			url : "findByUserRemarkAccount.do",
			type : "post",
...
//						console.log(UserRemark);
					...
					//登录账号？
					 var str="";
						...
						str+='</div>';
						str+='<div class="field" style="line-height: 38px;">';
						str+='<span>'+userWord+'</span>';
						str+='<br/><span style="float:right;"><i style="font-style:normal;">评论时间：</i>'+time1+'</span>';
...
//						console.log(adminReply);
						if(replyTime!=null||adminReply!=null){
							str+='<div class="field" style="line-height: 38px;">';	
							str+='<span>'+adminReply+'</span>';
							str+='<br/><span style="float:right;"><i style="font-style:normal;">回复时间：</i>'+time2+'</span>';	
							str+='</div>';
						}
						str+='</div>';
