...
<head>
    ...
    <script src="js/bookMore.js"></script>   
</head>
<body>
  ...
  <div class="form-x">   
    ...
    <div class="form-group">
      ...
      <div class="field">
        <textarea type="text" class="input" id="bookMore_userWord" name="s_desc" style="height:100px;background: #fff;cursor:default;"  readonly="readonly"cursor:default;></textarea>    
        <div class="tips"></div>     
      </div>
    </div>  
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="field">
        <textarea type="text" class="input" id="bookMore_adminReply" name="s_desc" style="height:100px;" ></textarea>     
