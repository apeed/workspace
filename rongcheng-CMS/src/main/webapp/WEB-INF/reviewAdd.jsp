...
setTimeout("document.getElementById('review_note_ts').style.display='none'",5000);
</script> 
</head>
<body>
  ...
  <div class="body-content">
    <div class="form-x">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" value=""  id="review_userTel" disabled="disabled" style="background: #fff;"  placeholder="请按格式输入0XXX-XXXXXXX"/>
