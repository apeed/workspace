...
<body style="background-color:#f2f9fd;">
  <div class="header bg-main">
    ...
    <div class="head-l">
      <a class="button button-little bg-green" href="javascript:;" target="_blank">
...
<div class="leftnav" style="overflow:auto;padding-bottom:80px;">
  ...
  <ul>
    <li class="pmx">
      <a href="websiteAnalysis/timeData.html" target="right">
        <span class="icon-caret-right"></span>
        <span>实时数据</span>
      </a>
    </li>
    <li class="pmx">
      <a href="websiteAnalysis/flowAnalysis.html" target="right">
        <span class="icon-caret-right"></span>
        <span>流量分析</span>
      </a>
    </li>  
    <li class="pmx">
      <a href="websiteAnalysis/PageAnalysis.html" target="right">
        <span class="icon-caret-right"></span>
        <span>页面分析</span>
      </a>
    </li>   
    <li class="pmx">
      <a href="websiteAnalysis/keywordAnalysis.html" target="right">
        <span class="icon-caret-right"></span>
        <span>关键词分析</span>
      </a>
    </li> 
  ...
  <ul>
    <li class="pmx">
      <a href="/clientele.do" target="right">
        <span class="icon-caret-right"></span>
        <span>客户管理</span>
      </a>
    </li> 
    <li class="pmx">
      <a href="/addresser.do" target="right">
        <span class="icon-caret-right"></span>
        <span>发件人管理</span>
      </a>
    </li> 
    ...
    <li class="pmx">
      <a href="/indent.do" target="right">
        <span class="icon-caret-right"></span>
        <span>订单管理</span>
      </a>
    </li> 
    <li class="pmx">
      <a href="/logistics.do" target="right">
        <span class="icon-caret-right"></span>
        <span>物流管理</span>
      </a>
    </li> 
    <li class="pmx">
      <a href="/review.do" target="right">
        <span class="icon-caret-right"></span>
        <span>评论管理</span>
      </a>
    </li>    
