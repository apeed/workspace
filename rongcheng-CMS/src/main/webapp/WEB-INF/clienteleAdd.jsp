...
<head>
	...
	<script src="js/clienteleAdd.js"></script>  
</head>
<body>
    ...
    <div class="body-content">
      <div class="form-x" >   
        ...
        <div class="form-group">
          ...
          <div class="field">
            <input type="text" class="input"  id="clientele_userTelephone" name="s_keywords" value=""  placeholder="请按格式输入0XXX-XXXXXXX"/>     
          ...
          <div class="field">
            <div class="button-group radio">
              ...
              <input  value="0"  type="radio" name="qt">停用
                 <span class="" id="clientele_accountStatus_ts" style="color:red"></span>
            </div> 
          </div>
        </div>
        <div class="form-group">
