...
<script src="js/logisticsPublic.js"></script>
    ...
    <div class="form-x">
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input"  id="logisticsPublic_operatorTel" name="views" value="" placeholder="1开头的11位手机号"/>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input"  id="logisticsPublic_transferCarrierId" name="views" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
