...
<link rel="stylesheet" href="css/search_xiala.css">
...
<script src="js/logisticsAdd.js"></script>
  ...
  <div class="body-content">
    <div class="form-x">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input"  id="logisticsAdd_operatorTel" name="views" value=""  placeholder="1开头的11位手机号"/>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="logisticsAdd_transferCarrierId"  name="views" />
