...
import com.rongcheng_tech.cms.exception.ExistChildrenBlockChannelException;
import com.rongcheng_tech.cms.service.BlockChannelService;
import com.rongcheng_tech.cms.utils.FileTool;
...
public class BlockChannelController {
     ...
     */
    @Resource
    private BlockChannelService blockChannelService;
    ...
    public JsonResult loadColumn(Integer[] recordType, String keywords, HttpSession session) {
    	...
    	System.out.println("BlockChannelController修改loadColumn");
        ...
        map.put("blockChannelList", 
                blockChannelService.listBlockChannel(recordType, ownerId, operatorId, authorization, keywords));
        //返回
    ...
    public JsonResult loadColumn(Integer[] recordType, Long operatorId, Boolean authorization, String keywords) {
        //定义返回集合
        Map<String, Object> map = new HashMap<String, Object>();
        //添加显示行数
        map.put("rows", rows);
    ...
    public JsonResult removeBlockChannel(Long[] blockChannelId, Long operatorId, Boolean authorization, 
        ...
        //删除内容
        int row = blockChannelService.removeBlockChannelById(blockChannelId, ownerId, operatorId, 
    ...
    public JsonResult loadColumnAddPublic(Integer[] recordType, Long blockChannelId, Long blockChannelParentId, 
            String buttonType, Boolean authorization, Long operatorId) {
        
        //创建返回map
        Map<String, Object> map = new HashMap<String, Object>();
        
        //根据父类ID查找最大序号
        map.put("userSequence", blockChannelService.
        ...
        if ("column_publicParent".equals(buttonType) || "column_publicChildren".equals(buttonType) || 
            ...
            //根据栏目ID查找单条栏目
            map.put("blockChannel", blockChannelService.getBlockChannelById(blockChannelId, ownerId, operatorId, authorization));
...
//            }
    ...
    public JsonResult columnAddPublicCommit(HttpServletRequest request) {
...
//        Long ownerId = Long.valueOf(multipartRequest.getParameter("ownerId"));
        Long operatorId = Long.valueOf(multipartRequest.getParameter("operatorId"));
        ...
        if ("column_addParent".equals(buttonType) || "column_addChildren".equals(buttonType) || 
            ...
            //添加
            row = blockChannelService.saveBlockChannel(blockTitle, blockSubtitle, enTitle, blockProfile, 
        ...
        //如果是修改
            ...
            //如果没有更新图片，返回的是error
            if(!imgPath.equals("mediafile/icons/block/error") || !imgPath.equals("mediafile/icons/categories/error")){
                
                //获取路径
                String url = blockChannelService.getBlockChannelById(blockChannelId, 
                ...
                //获取路径
                imgPath = blockChannelService.getBlockChannelById(blockChannelId, 
                        ownerId, operatorId, authorization).getIconUrl();
            }
            
            //修改
            row = blockChannelService.modifyBlockChannel(blockChannelId, blockTitle, blockSubtitle, enTitle, 
